...
public:
    ...
    //Port scan TCP
    bool portScan_udp(std::string ip, int port, long timeout_sec, long timeout_usec);
    //OVerload
    bool portScan_udp(Port *port_ptr, std::string ip, int port, long timeout_sec, long timeout_usec);
